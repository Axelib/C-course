...
int remainingOvenTime(int actualMinutesInOven) {
    ...
    int timeoven= ovenTime();
    return timeoven - actualMinutesInOven ;
}
...
int elapsedTime(int numberOfLayers, int actualMinutesInOven) {
    ...
    int prtime=preparationTime(numberOfLayers);
    return prtime + actualMinutesInOven;
}
