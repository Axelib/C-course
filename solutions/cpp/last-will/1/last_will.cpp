...
namespace estate_executor {
    // Aquí irás agregando el código de las siguientes tareas.
    int assemble_account_number(int secret_modifier)
    {
        int total=zhang::bank_number_part(secret_modifier)+khan::bank_number_part(secret_modifier)+garcia::bank_number_part(secret_modifier);
        return total;
    }
    int assemble_code()
    {
